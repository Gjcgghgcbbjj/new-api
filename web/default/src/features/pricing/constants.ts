...
export const ENDPOINT_TYPES = {
  ...
  OPENAI_RESPONSE_VIA_CHAT: 'openai-response-via-chat',
...
export function getEndpointTypeLabels(
  ...
  return {
    ...
    [ENDPOINT_TYPES.OPENAI_RESPONSE_VIA_CHAT]: 'Response via Chat',
    [ENDPOINT_TYPES.OPENAI_RESPONSE_COMPACT]: 'Response Compact',
